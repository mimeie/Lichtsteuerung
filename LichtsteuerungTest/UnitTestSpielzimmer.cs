...
namespace LichtsteuerungTest
{
    ...
    public class UnitTestSpielzimmer
    {
        ...
        private void InitializeDefaultValues()
        {
            ...
            SteuerungLogic.Instance.LichtsteuerungSpielzimmer.LichtSpielzimmer.ZielStatus = false;
        }
        ...
        {
            //licht schaltet ein
            SteuerungLogic.Instance.LichtsteuerungSpielzimmer.LichtSpielzimmer.ZielStatus = true;
        ...
        public void SpielzimmerLichtAusBewegung()
        {
            try
            {
                ...
                SteuerungLogic.Instance.LichtsteuerungSpielzimmer.SpielzimmerBewegung.DebugSetStatus(true);
